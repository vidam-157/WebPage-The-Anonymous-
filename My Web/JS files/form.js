...
function getdetails() {
	...
	document.getElementById("detailviwer").innerHTML = "<div>" + "First Name: "+ name1.value + "<span></span></div><br>"+
													   ...
													   "<div>" + "Description: " + feedback.value + "<span></span></div><br>";
}
...
function sendForm () {
		alert("Detais Sent, Anonymous will connect you soon!.");
 		location.reload();
}